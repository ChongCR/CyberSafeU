<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="sCourseManagement.aspx.cs" Inherits="WebApplication1.sCourseManagement" %>
  ...
  <div class="row justify-content-center">
    ...
    <PagerStyle CssClass="grid-view-pager" />
            ...
            <asp:Button ID="MarkAsCorrectButton" runat="server" Text="Approve" 
                CssClass="btn btn-success" OnClick="MarkAsCorrect_Click" CommandArgument='<%# Eval("CourseCode") %>' />
            &nbsp;
            <asp:Button ID="MarkAsFalseButton" runat="server" Text="Reject" 
                CssClass="btn btn-danger" OnClick="MarkAsFalse_Click" CommandArgument='<%# Eval("CourseCode") %>' />
                            </ItemTemplate>
